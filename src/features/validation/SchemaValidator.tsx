/**
 * Schema Validator
 * Validates autoinstall configuration against the official Ubuntu schema
 */
 ...
 * Validates autoinstall configurations against official schema
 */
export const SchemaValidator = {
  ...
  validate(config: AutoinstallConfig): ValidationResult {
    ...
    if (!config.autoinstall) {
      ...
      return { valid: false, errors, warnings, summary: { total: 1, errors: 1, warnings: 0 } };
    }
...
export function ValidationModal({ isOpen, onClose, results }: ValidationModalProps) {
