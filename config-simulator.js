// Configuration Simulator Module
...
const ConfigSimulatorModal = ({ isOpen, onClose, autoinstallYaml }) => {
    ...
    React.useEffect(() => {
        if (isOpen && autoinstallYaml) {
            try {
                ...
                setError(`Error simulating configuration: ${e.message}`);
                setSimulation(null);
            }
        }
...
// Export to window
window.ConfigSimulator = ConfigSimulator;
window.ConfigSimulatorModal = ConfigSimulatorModal;
