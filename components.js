...
const KeyboardShortcutsModal = ({ isOpen, onClose, shortcuts }) => {
    ...
    const shortcutsList = shortcuts || [
        { key: 'Ctrl+S', description: 'Download autoinstall.yaml' },
        { key: 'Ctrl+O', description: 'Load YAML file' },
        { key: 'Ctrl+Z', description: 'Undo last change' },
        { key: 'Ctrl+Y', description: 'Redo last change' },
        { key: 'Ctrl+Shift+Y', description: 'Redo (alternative)' },
        { key: 'Ctrl+K', description: 'Open version manager' },
        { key: 'Ctrl+B', description: 'Save to bookmark' },
        { key: 'Ctrl+/', description: 'Show keyboard shortcuts' },
        { key: 'Ctrl+Shift+C', description: 'Copy YAML to clipboard' },
        { key: 'Ctrl+Shift+V', description: 'Validate configuration' },
        { key: 'Ctrl+Shift+T', description: 'Open templates' },
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-6">
                    {shortcutsList.map((shortcut, idx) => (
                        <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <kbd className="px-2 py-1 text-xs font-semibold text-gray-800 bg-gray-200 dark:bg-gray-600 dark:text-gray-200 border border-gray-400 dark:border-gray-500 rounded-lg shadow-sm">
                                {shortcut.key}
                            </kbd>
                        </div>
                    ))}
