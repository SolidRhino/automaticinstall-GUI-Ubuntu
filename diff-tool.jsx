// Configuration Diff Tool Module
...
const DiffModal = ({ isOpen, onClose }) => {
    const [config1Text, setConfig1Text] = React.useState('');
    const [config2Text, setConfig2Text] = React.useState('');
    ...
    const handleFileLoad = (event, setConfig) => {
